...
public class ScheduleResourceFromEntityAssembler {
    public static ScheduleResource toResourceFromEntity(Schedule entity){
        return new ScheduleResource(entity.getId(), entity.getName(), entity.getSpecies(), entity.getSize(),entity.getMass(),entity.getFoodKind(),entity.getFoodWeight(),entity.getLoopC(), entity.getSensorConditionA(), entity.getSensorConditionB(), entity.getComment());
    }
}
